...
*   The data pipeline successfully maps these N=400 cohorts across paradigm boundaries without relying on textual tokenizers, overcoming the hallucination pitfalls seen in neural models like CodeBERT.
...
*   `final_similarity_matrix_java.json`: The aggregated baseline providing our final academic accuracy metrics utilizing the optimized 35/40/25% scaling weights.
