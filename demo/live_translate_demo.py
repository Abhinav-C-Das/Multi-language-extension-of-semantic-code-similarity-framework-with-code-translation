...
def main():
    if len(sys.argv) < 3:
        print("Usage: python live_translate_demo.py <input_file> <target_language>")
        print("Example: python live_translate_demo.py live_input_translation/random_code.c java")
        sys.exit(1)
    ...
    print("\n" + "="*60)
    print(" 🚀 INTERACTIVE FRAMEWORK: APM CODE TRANSLATION")
    print("="*60)
    ...
    # Save the generated file directly to the same folder as the input so it's easy to find!
