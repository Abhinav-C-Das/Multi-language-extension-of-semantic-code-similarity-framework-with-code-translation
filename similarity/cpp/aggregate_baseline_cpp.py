#!/usr/bin/env python3
"""
Aggregate baseline features for C++ programs
Combines structural, semantic, behavioral, and variable_roles features
"""
import json
import sys
...
if len(sys.argv) != 2:
    print("Usage: python aggregate_baseline_cpp.py <features_dir>")
    sys.exit(1)
