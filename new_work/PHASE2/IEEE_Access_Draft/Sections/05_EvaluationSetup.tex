...
\textbf{Cross-language corpus:} 400-programs cross-language corpus consists of programs written in C, C++, and Java. Ground truth strategy labels for all 400 programs were provided using hard-filtering constraint (Section~\ref{subsec:late_fusion}).
