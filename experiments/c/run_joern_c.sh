...
LANGUAGE="c"
DATA_DIR="${DATA_DIR:-data/c}"
OUT_DIR="${OUT_DIR:-outputs}"
SCRIPTS_DIR="cpg/scripts/c"
CPG_BASE="${CPG_BASE:-cpgs}"
# LANG_SUBDIR: subdirectory under OUT_DIR for this language.
# Default: "c" (standalone mode). Set to "" for cross-language (flat) mode.
LANG_SUBDIR="${LANG_SUBDIR:-c}"
...
echo "[✓] Joern feature extraction complete for C (CPG reused)"
